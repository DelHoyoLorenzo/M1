...
function cacheFunction(cb) {
  // esta funcion debe almacenar el resultado de cada operacion de cb
  let memoria={};
...
let getNombreInstructor = getNombre.bind(instructor, 'nombre');
let getNombreAlumno = getNombre.bind(alumno, 'nombre');
